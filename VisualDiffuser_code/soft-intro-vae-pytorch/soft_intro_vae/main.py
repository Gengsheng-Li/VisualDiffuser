...
from train_soft_intro_vae_condition import train_soft_intro_vae
...
if __name__ == "__main__":
    ...
    train_soft_intro_vae(dataset=args.dataset, z_dim=args.z_dim, batch_size=args.batch_size, num_workers=0, num_epochs=args.num_epochs,
                         num_vae=args.num_vae, beta_kl=args.beta_kl, beta_neg=args.beta_neg, beta_rec=args.beta_rec,
                         device=device, save_interval=1, start_epoch=0, lr_e=args.lr, lr_d=args.lr,
                         pretrained=pretrained, seed=args.seed,
                         test_iter=300, with_fid=args.fid)
